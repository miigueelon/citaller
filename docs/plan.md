...
- **Cierre**: `get_advisors` sin WARN nuevo más allá de los aceptados; `rls-test.sql` en verde salvo las tres "(despliegue)"; flujos C, D, E, F verificados; tag `v0-fase1`. **Parar.**
