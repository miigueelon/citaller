...
- **Cierre**: `get_advisors` sin WARN de seguridad salvo los aceptados y documentados (RPC públicas SECURITY DEFINER por diseño, y contraseñas filtradas: requiere plan Pro); `rls-test.sql` en verde salvo las tres "(despliegue)"; flujos C, D, E, F verificados; tag `v0-fase1`. **Parar.**
